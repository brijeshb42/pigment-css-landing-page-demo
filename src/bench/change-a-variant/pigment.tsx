...
const Button = styled('button')({
  ...buttonStyles,
  variants: Object.keys(buttonVariants.variants).flatMap((key) => {
    return Object.keys(buttonVariants.variants[key]).map((varKey) => ({
      props: {
        [key]: varKey,
      },
      style: buttonVariants.variants[key][varKey],
    }));
  }),
});
